    ...
    case prefix+'dare':
        ...
        case prefix+'googleimage':
         ...
         case prefix+'tahta':
             ...
             if (jreng.length > 12) return tobz.reply(from, 'Maksimal 12 Huruf!', id)
	...
	case prefix+'howgay':
       ...
       case prefix+'opromote':
		...
		case prefix+'udm':
            ...
            break
        case prefix+'join':
			if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin Bot!', id)
