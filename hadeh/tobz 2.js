     ...
     /*   case prefix+'ig': 
        ...
        case prefix+'waktu':
           ...
           case prefix+'ttnowm':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah *${prefix}ttnowm [ Link tiktod ]*\nContoh : *${prefix}ttnowm https://www.tiktok.com/@bellapoarch/video/6871376520468794629*`, id)
            await tobz.reply(from, mess.wait, id)
